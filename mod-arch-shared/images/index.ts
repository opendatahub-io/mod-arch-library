...
import emptyStateClusterStorage from './empty-state-cluster-storage.svg';
import emptyStateDataConnections from './empty-state-data-connections.svg';
import emptyStateModelRegistries from './empty-state-model-registries.svg';
import emptyStateModelServing from './empty-state-model-serving.svg';
import emptyStateNotebooks from './empty-state-notebooks.svg';
import emptyStatePipelines from './empty-state-pipelines.svg';
...
import logoDarkThemePath from './logo-odh-dark-theme.svg';
import logoLightThemePath from './logo-odh-light-theme.svg';

// Export all images
export {
  emptyStateClusterStorage,
  emptyStateDataConnections,
  emptyStateModelRegistries,
  emptyStateModelServing,
  emptyStateNotebooks,
  emptyStatePipelines,
