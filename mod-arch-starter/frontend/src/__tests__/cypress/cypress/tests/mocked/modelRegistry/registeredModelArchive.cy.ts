...
describe('Model archive list', () => {
  it('No archive models in the selected model registry', () => {
    ...
    verifyRelativeURL('/mod-arch/modelregistry-sample/registeredModels/archive');
  ...
  it('Archived model details browser back button should lead to archived models table', () => {
    ...
    verifyRelativeURL('/mod-arch/modelregistry-sample/registeredModels/archive/2/overview');
  ...
  it('Archived model flow', () => {
    ...
    verifyRelativeURL('/mod-arch/modelregistry-sample/registeredModels/archive/2/versions');
    ...
    verifyRelativeURL(
      '/mod-arch/modelregistry-sample/registeredModels/archive/2/versions/1/details',
    );
    cy.go('back');
    verifyRelativeURL('/mod-arch/modelregistry-sample/registeredModels/archive/2/versions');
  });
  ...
  it('Opens the detail page when we select "Overview" from action menu and verison list when we select "Versions', () => {
    ...
    cy.location('pathname').should(
      'be.equals',
      '/mod-arch/modelregistry-sample/registeredModels/archive/2/overview',
    );
    cy.go('back');
