...
describe('Model Registry core', () => {
  ...
  describe('Registered model table', () => {
    ...
    it('latest version column', () => {
      ...
      verifyRelativeURL(
        `/mod-arch/modelregistry-sample/registeredModels/1/versions/1/details`,
      );
    });
    ...
    it('table kebab actions', () => {
      ...
      verifyRelativeURL(`/mod-arch/modelregistry-sample/registeredModels/1/versions`);
      cy.go('back');
      registeredModelRow.findKebabAction('Overview').click();
      verifyRelativeURL(`/mod-arch/modelregistry-sample/registeredModels/1/overview`);
    });
...
describe('Register Model button', () => {
  ...
  it('should redirect to version details page after successful model registration', () => {
    ...
    const expectedUrlPattern =
      '/mod-arch/modelregistry-sample/registeredModels/test-model-id/versions/test-version-id';
    cy.url().should('include', '/mod-arch/modelregistry-sample/registerModel');
