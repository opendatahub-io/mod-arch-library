...
describe('Model Versions Card', () => {
  ...
  it('does not display model versions list if there are no live model versions', () => {
    cy.visit('/mod-arch/modelregistry-sample/registeredModels/1/overview');
    cy.interceptApi(
      `GET /api/:apiVersion/model_registry/:modelRegistryName/registered_models/:registeredModelId/versions`,
      {
        path: {
  ...
  it('does not display model versions list if there are no archived model versions', () => {
    cy.visit('/mod-arch/modelregistry-sample/registeredModels/archive/2/overview');
    cy.interceptApi(
      `GET /api/:apiVersion/model_registry/:modelRegistryName/registered_models/:registeredModelId/versions`,
      {
        path: {
  ...
  it('should display live model versions list correctly', () => {
    ...
    cy.url().should('include', '/mod-arch/modelregistry-sample/registeredModels/1/versions');
  });
  ...
  it('should display archived model versions list correctly', () => {
    ...
    cy.url().should(
      'include',
      '/mod-arch/modelregistry-sample/registeredModels/archive/2/versions',
    );
  });
  ...
  it('should have the correct link to the live model version', () => {
    ...
    cy.url().should(
      'include',
      '/mod-arch/modelregistry-sample/registeredModels/1/versions/4/details',
    );
  ...
  it('should have the correct link to the archived model version', () => {
    ...
    cy.url().should(
      'include',
      '/mod-arch/modelregistry-sample/registeredModels/archive/2/versions/8/details',
    );
