// TODO: Replace this local copy with the upstream mod-arch-shared component when the default flavor can depend on mod-arch-shared again.
...
const NotFound: React.FC = () => (
  <PageSection hasBodyWrapper={false}>
    ...
    >
      ...
      <EmptyStateFooter>
        <Button icon={<HomeIcon />} data-testid="home-page-button" component="a" href="/" variant="primary">
          Home
        </Button>
      </EmptyStateFooter>
    </EmptyState>
